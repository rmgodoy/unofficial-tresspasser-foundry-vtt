...
/**
 * Data model for the Trespasser TTRPG NPC actor type.
 */
export class TrespasserNPCData extends foundry.abstract.TypeDataModel {
  ...
  prepareDerivedData() {
    ...
    // NPC stats stay as pure base values.
