...
export class TrespasserTokenHUD extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    _getVaultRange() {
        ...
        // For characters, commoners & companions: use the derived speed_bonus (already includes agility, min 2, and effect bonuses)
    ...
    async _executeAttemptDeed() {
        ...
        if (item && item.type === "deed") {
            ...
            const executor = new DeedExecutor(item, this._token.actor, { apSpent, token: this._token });
